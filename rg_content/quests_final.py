...
Questy 1-23 sa zaakceptowane projektowo i stanowia aktywna zawartosc produkcyjna.
"""
...
QUESTS = QUESTS_01_08 + QUESTS_09_16 + QUESTS_17_23
EXPANSIONS = ()
...
def register_all_quests() -> None:
    """Rejestruje wylacznie finalne Questy produkcyjne 1-23."""
    global _REGISTERED
    if _REGISTERED:
        return
