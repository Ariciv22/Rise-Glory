            ...
            "methods": [
                {
                    ...
                    "failure_text": "Banda odpiera atak. Obowiązują standardowe konsekwencje przegranej walki.",
                },
                {
                    "id": "podstep",
                    ...
                    "failure_text": "Podstęp zostaje odkryty. Tracisz 2 Złota.",
                    "failure": {"gold": 2},
                },
                {
                    "id": "ugodowo",
                    ...
                    "failure_text": "Banda bierze pieniądze, ale zostaje na trakcie. Tracisz dodatkowo 1 Akcję.",
                    "failure": {"actions": 1},
                },
            ],
        },
            ...
            "methods": [
                {
                    ...
                    "difficulty": 16,
                    "costs": {"gold": 12},
                    "failure_text": "Ekipa rezygnuje po zobaczeniu rozmiaru lawiny. Wydane 12 Złota nie wraca.",
                },
                {
                    "id": "wspinaczka",
                    ...
                    "failure_text": "Podczas wspinaczki tracisz oparcie. Otrzymujesz 1 Ranę.",
                    "failure": {"wounds": 1},
                },
            ],
        },
            ...
            "methods": [
                {
                    ...
                    "difficulty": 14,
                    "requirements": {"goods": "Lina"},
                    "failure_text": "Gubisz trop i także siebie w lesie. Tracisz 2 Akcje.",
                    "failure": {"actions": 2},
                },
                {
                    "id": "przekup",
                    ...
                    "difficulty": 11,
                    "costs": {"gold": 6},
                    "failure_text": "Biorą pieniądze i nadal zatruwają drzewa. Tracisz dodatkowo 1 Akcję.",
                    "failure": {"actions": 1},
                },
                {
                    "id": "dyplomacja",
                    ...
                    "difficulty": 15,
                    "costs": {"gold": 3},
                    "failure_text": "Rozmowa przeradza się w groźby. Tracisz 1 Punkt Legendy, nie mniej niż do 0.",
                    "failure": {"legend": 1},
                },
            ],
        },
        ...
        "problem": {
            ...
            "methods": [
                ...
                },
                {
                    ...
                    "stat": "Nauka",
                    "difficulty": 13,
                    "failure_text": "Źle oceniasz osuwisko. Tracisz dodatkowo 1 Akcję.",
                    "failure": {"actions": 1},
                },
                {
                    "id": "robotnicy",
                    ...
                    "difficulty": 11,
                    "costs": {"gold": 8},
                    "failure_text": "Robotnicy biorą zaliczkę, ale odmawiają dalszej pracy. Wydane 8 Złota nie wraca.",
                },
            ],
        },
    },
